 ...
 */
package com.fabrice.webapp.core.Utils;
...
public class ManipulationDate {
     ...
     * @return long
     */
    public static long NombreJourEntreDeuxDates(TimeUnit units, Date date1, Date date2){
        ...
        return units.convert(dateConvert2.getTimeInMillis() - dateConvert1.getTimeInMillis(), TimeUnit.MILLISECONDS);
